...
# @routerTime.get("/next_medication/")
...
#         db = SessionLocal()
#         try:
#             time_ids = crud_time.get_time_arduino(db, global_user_id)
#             if time_ids:
#                 return {"status": "success", "message": "Horário encontrado", "data": time_ids}
#             else:
#                 return {"status": "success", "message": "Nenhum horário correspondente"}
#         finally:
#             db.close()
#     else:
#         return {"status": "error", "message": "Nenhum usuário logado"}